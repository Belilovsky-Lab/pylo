...
def get_dataset(args):
    ...
    if args.dataset_name == 'imagenet':
        H5Data(h5_path=f'/home/datasets/tensorflow_datasets/imagenet_{args.image_size}x{args.image_size}x3_JPEG.h5')
...
if __name__ == '__main__':
    ...
    IS = args.image_size
    args.group_name = f"mup_small_fc_mlp32_['mumlp-w{args.width}-d3_{args.dataset_name}-{IS}x{IS}x3']_m_mup_final_troch-cuda-fp32-act-naive"
