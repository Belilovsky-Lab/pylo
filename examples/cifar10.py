...
# Data loaders
train_dataset = CIFAR10(root=os.environ["DATA_PATH"], train=True, 
                       download=True, transform=transform)
test_dataset = CIFAR10(root=os.environ["DATA_PATH"], train=False,
                      download=True, transform=transform)

train_loader = DataLoader(train_dataset, batch_size=batch_size, 
                         shuffle=True, num_workers=no_of_workers)
test_loader = DataLoader(test_dataset, batch_size=batch_size,
                        shuffle=False, num_workers=no_of_workers)
